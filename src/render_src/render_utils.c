...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/25 12:29:59 by cycolonn          #+#    #+#             */
/*   Updated: 2026/06/25 12:30:18 by cycolonn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_display_fps(t_data *data)
{
	...
	mlx_string_put(data->mlx, data->mlx_win, data->win_size.x - 100, 40,
		0xFFFF00, "fps: ");
	mlx_string_put(data->mlx, data->mlx_win, data->win_size.x - 60, 40,
		0x00FF1A, fps);
	free(fps);
}
